...
## Compatibility
✅ [**Tangerine UI** (v2._x_)](https://github.com/nileane/TangerineUI-for-Mastodon/releases/latest) **is compatible with instances running the [latest stable release of Mastodon](https://github.com/mastodon/mastodon/releases/tag/v4.4.8) (currently Mastodon 4.4.x)**[^3][^4]
